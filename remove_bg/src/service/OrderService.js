...
// import { Currency, Plane, Receipt } from "lucide-react";
// import { useContext } from "react";
// import toast from "react-hot-toast";



// export const placeOrder=async({PlaneId ,getToken,onSuccess,backendUrl})=>{
//     try {
// const  token =await getToken();
 

// const response = await axios.post(
//         `${backendUrl}/orders?planeId=${PlaneId}`,{},
...
//  const response = await axios.post(
//         `${backendUrl}/orders/verify`,paymentDetails,
